...
class Product extends Controller
{
    ...
    public function index()
    {
        ...
        // 商品分类
        $category = CategoryModel::getCacheTree(1);
        // 数量
        $product_count = [
    ...
    {
        return $this->renderSuccess('', array_merge(ProductService::getEditData(null, 'add', 1), []));
    }
    ...
    public function getEditData($product_id, $scene = 'edit')
    {
        ...
        return $this->renderSuccess('', array_merge(ProductService::getEditData($model, $scene, 1), compact('model')));
    }

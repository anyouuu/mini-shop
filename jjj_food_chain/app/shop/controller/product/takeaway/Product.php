...
class Product extends Controller
{
    ...
    public function index()
    {
        ...
        // 商品分类
        $category = CategoryModel::getCacheTree(0);
        // 数量
        $product_count = [
    ...
    {
        return $this->renderSuccess('', array_merge(ProductService::getEditData(null, 'add', 0), []));
    }
    ...
    public function edit($product_id, $scene = 'edit')
    {
        if ($this->request->isGet()) {
            ...
            return $this->renderSuccess('', array_merge(ProductService::getEditData($model, $scene, 0), compact('model')));
        }
        if ($scene == 'copy') {

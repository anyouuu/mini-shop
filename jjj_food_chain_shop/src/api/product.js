...
let ProductApi = {
    ...
    AttributeList(data, errorback) {
        return request._post('/shop/product.Attribute/index', data, errorback);
    },
    addAttribute(data, errorback) {
        return request._post('/shop/product.Attribute/add', data, errorback);
    },
    editAttribute(data, errorback) {
        return request._post('/shop/product.Attribute/edit', data, errorback);
    },
    deleteAttribute(data, errorback) {
        return request._post('/shop/product.Attribute/delete', data, errorback);
    },
    /*加料库*/
    FeedList(data, errorback) {
        return request._post('/shop/product.Feed/index', data, errorback);
    },
    addFeed(data, errorback) {
        return request._post('/shop/product.Feed/add', data, errorback);
    },
    editFeed(data, errorback) {
        return request._post('/shop/product.Feed/edit', data, errorback);
    },
    deleteFeed(data, errorback) {
        return request._post('/shop/product.Feed/delete', data, errorback);
    },
    /*规格库*/
    SpecList(data, errorback) {
        return request._post('/shop/product.Spec/index', data, errorback);
    },
    addSpec(data, errorback) {
        return request._post('/shop/product.Spec/add', data, errorback);
    },
    editSpec(data, errorback) {
        return request._post('/shop/product.Spec/edit', data, errorback);
    },
    deleteSpec(data, errorback) {
        return request._post('/shop/product.Spec/delete', data, errorback);
    },
    /*单位库*/
    UnitList(data, errorback) {
        return request._post('/shop/product.Unit/index', data, errorback);
    },
    addUnit(data, errorback) {
        return request._post('/shop/product.Unit/add', data, errorback);
    },
    editUnit(data, errorback) {
        return request._post('/shop/product.Unit/edit', data, errorback);
    },
    deleteUnit(data, errorback) {
        return request._post('/shop/product.Unit/delete', data, errorback);
    },

<template>
  ...
  <div>
    ...
    <el-form-item label="商品重量(Kg)：" :rules="[{ required: true, message: '请填写商品重量' }]" prop="model.sku[0].product_weight">
      <el-input type="number" v-model="form.model.sku[0].product_weight" class="max-w460"></el-input>
    </el-form-item>
  </div>
</template>

<template>
  ...
  <div class="product-list">
    ...
    <div class="common-level-rail">
      <el-button size="small" type="primary" icon="el-icon-plus" v-auth="'/product/expand/feed/add'" @click="addClick">
        添加加料</el-button>
    ...
    <div class="product-content">
      <div class="table-wrap">
        <el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading"
          ...
          <el-table-column prop="feed_id" label="ID"></el-table-column>

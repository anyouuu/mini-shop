<template>
  ...
  <div class="product-list">
    ...
    <div class="common-seach-wrap">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        ...
        <el-tab-pane label="下架" name="lower">
          <span slot="label">下架 <el-tag size="mini">{{product_count.lower}}</el-tag></span>
        </el-tab-pane>
      </el-tabs>
    ...
    <!--添加产品-->
    <div class="common-level-rail"><el-button size="small" type="primary" icon="el-icon-plus" v-auth="'/product/takeaway/product/add'" @click="addClick">添加产品</el-button></div>
    <!--内容-->

     ...
     <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="普通分类" name="first">
          <div class="common-level-rail">
            <el-button size="small" type="primary" @click="addClick" icon="el-icon-plus" v-auth="'/product/takeaway/category/Add'">添加分类</el-button>
          </div>
          <!--内容-->
            ...
            <div class="table-wrap">
              <el-table size="small" :data="tableData" row-key="category_id" default-expand-all :tree-props="{children: 'child'}"
                ...
                <el-table-column fixed="right" label="操作" width="100">
                  <template slot-scope="scope">
                    <el-button @click="editClick(scope.row)" type="text" size="small" v-auth="'/product/takeaway/category/Edit'">编辑</el-button>
                    <el-button @click="deleteClick(scope.row)" type="text" size="small" v-auth="'/product/takeaway/category/Delete'">删除</el-button>
                  </template>
                </el-table-column>
              </el-table>
            </div>

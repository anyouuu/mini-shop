<template>
  ...
  <div class="product">
    ...
    <div class="common-level-rail">
      <el-button size="small" type="primary" @click="addClick" icon="el-icon-plus" v-auth="'/store/table/type/add'">添加类型</el-button>
    </div>
    <!--内容-->
    <div class="product-content">
      <div class="table-wrap">
        <el-table size="small" :data="tableData" row-key="type_id"  style="width: 100%" v-loading="loading">
          ...
          <el-table-column prop="type_name" label="类型名称" width="180"></el-table-column>
          <el-table-column prop="max_num" label="人数区间" width="180">
          ...
          <el-table-column fixed="right" label="操作" width="100">
            <template slot-scope="scope">
              <el-button @click="editClick(scope.row)" type="text" size="small"
                v-auth="'/store/table/type/edit'">编辑</el-button>
                <el-button @click="deleteClick(scope.row)" type="text" size="small" v-auth="'/store/table/type/delete'">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
